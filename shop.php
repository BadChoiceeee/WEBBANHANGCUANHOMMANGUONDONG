                ...
                <div class="col-lg-9 col-md-7">
                    <div class="product__discount">
                        ...
                        <div class="row">
                            ...
                            <?php
                                require('./db/connectDB.php');
                                $sql_str = "SELECT products.name AS pname, categories.name AS cname, ROUND((price - disscounted_price) / price * 100) AS discount, images, price, disscounted_price FROM products, categories WHERE products.category_id = categories.id ORDER BY discount DESC LIMIT 0, 5;";
                                $result = mysqli_query($conn, $sql_str);
                                while ($row = mysqli_fetch_assoc($result)) {
                                    $anh_arr = explode(';', $row['images']);
                            ?>
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            ...
                                            <h5><a href="#"><?php echo htmlspecialchars($row['pname']); ?></a></h5>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    <h6><a href="#"><?php echo htmlspecialchars($row['name']); ?></a></h6>
