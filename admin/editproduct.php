...
foreach($arr as $img)
    echo "<img src='$img' height='100px' />";
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="summary" class="form-control" placeholder="Nhập..."><?= trim(htmlspecialchars($product['summary'])) ?></textarea>

                    </div>
                    <div class="form-group">
                    <label class="form-label">Mô tả sản phẩm:</label>
                    <textarea name="description" class="form-control" placeholder="Nhập..."><?= trim(htmlspecialchars($product['description'])) ?></textarea>
                    </div>
    ...
    while ($row = mysqli_fetch_assoc($result)){
        ...
        <?php } ?>
                    ...
                    <a href="./listsanpham.php" class="btn btn-secondary">Đóng</a>
                    </form>
                    <hr>
